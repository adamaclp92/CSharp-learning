...
namespace _01_Neptun
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Hallgato hallgato = new Hallgato("IKSI78");
            hallgato.Nev = "Troll Ede";
            hallgato.SzuletesiDatum =
            ...
            Hallgato hallgato2 = new Hallgato("XX666X",
                new DateTime(1964, 3, 21));
            hallgato2.Nev = "Keresztes Péter";
            //hallgato2.NeptunKod = "XX666X";
            //hallgato2.SzuletesiDatum =
            //    new DateTime(1964, 3, 21);
            hallgato2.Neme = Nem.FERFI;
            hallgato2.Kreditek = 181;
            Hallgatok.Add(hallgato2);

            Hallgato hallgato3 = new Hallgato("QWERTY");
            hallgato3.Nev = "Biró Csaba";
            //hallgato3.NeptunKod = "QWERTY";
            hallgato3.SzuletesiDatum =
                new DateTime(1983, 6, 5);
            //hallgato3.SzuletesiDatum =
            //    new DateTime(1983, 6, 5);
